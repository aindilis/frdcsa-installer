...
void OR_PREMISE::Load(ulong ind,const Clause* c)
{
...
void OR_PREMISE::LoadOptimized(ulong ind,const Clause* c)
{
  ...
  if (last_max)
    ...
    {
      _maxLiteral[0] = (PREFIX_SYM*)0; // just in case
