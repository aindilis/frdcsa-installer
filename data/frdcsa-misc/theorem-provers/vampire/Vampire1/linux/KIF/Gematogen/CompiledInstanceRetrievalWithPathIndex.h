//
// File:         CompiledInstanceRetrievalWithPathIndex.h
...
//============================================================================
#ifndef COMPILED_INSTANCE_RETRIEVAL_WITH_PATH_INDEX_H
//=============================================================================      
...
//============================================================================
#define COMPILED_INSTANCE_RETRIEVAL_WITH_PATH_INDEX_H 
#ifndef NO_DEBUG_VIS
 #include <iostream.h>
#endif 
#include "jargon.h"
...
#ifdef DEBUG_COMPILED_INSTANCE_RETRIEVAL_WITH_PATH_INDEX
 #define DEBUG_NAMESPACE "CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>"
#endif
...
class CompiledInstanceRetrievalIndex
{ 
 public:
  ...
  #endif
 public:
  CompiledInstanceRetrievalIndex() 
   : _trie(),
  ...
  ~CompiledInstanceRetrievalIndex()
    {
      CALL("destructor ~CompiledInstanceRetrievalIndex()");
 ...
 private: 
  class CompiledInstanceRetrievalIndexNonmaxPathRelationId {};
  class CompiledInstanceRetrievalIndexMaxPathRelationId {};
  typedef SmallHeaderVoidSkipList<Alloc,TermId,2,CompiledInstanceRetrievalIndexNonmaxPathRelationId> NonmaxPathRelation; 
  typedef SmallHeaderVoidSkipList<Alloc,TermId,2,CompiledInstanceRetrievalIndexMaxPathRelationId> MaxPathRelation;  
...
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::integrate(const TermId& integratedTermId)
{
   ...
   { 
    ...
    case TermTraversal::End: 
     ...
     default: ICP("ICP0"); return false;
      ...
      default: 
       RuntimeError::report("Wrong term traversal state in CompiledInstanceRetrievalIndex<..>::integrate(..)");
       return false;
     #endif
    #endif       
   };
} // bool CompiledInstanceRetrievalIndex<..>::integrate(const TermId& integratedTermId)



template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::remove(const TermId& removedTermId)
{
  ...
  switch (_removedTermTraversal.state())
   { 
    ...
    case TermTraversal::End: 
     ...
     #ifdef _SUPPRESS_WARNINGS_
      default: 
       RuntimeError::report("Wrong term traversal state in CompiledInstanceRetrievalIndex<..>::remove(..)");
       return false;
     #endif
    #endif       
   };

} // bool CompiledInstanceRetrievalIndex<..>::remove(const TermId& removedTermId)



template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline void CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::destroy()
{
 CALL("destroy()");
 bool wasConstant;
...
} // void CompiledInstanceRetrievalIndex<..>::destroy()


template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::compileQuery(const TermId& query)
{
  ...
  switch (_queryTraversal.state())
   {
    ...
    case TermTraversal::End: 
     ...
     #ifdef _SUPPRESS_WARNINGS_
      default: 
       RuntimeError::report("Wrong term traversal state in CompiledInstanceRetrievalIndex<..>::compileQuery(..)");
       return false;
     #endif
    #endif    
  };
 
} // bool CompiledInstanceRetrievalIndex<..>::compileQuery(const TermId& query)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::nextMatch(TermId& matchId)
{
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_COMPILED_INSTANCE_RETRIEVAL_WITH_PATH_INDEX
 #define DEBUG_NAMESPACE "CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation"
#endif
#include "debugMacros.h"
//============================================================================
...
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline void CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::reset()
{
 CALL("reset()");
...
} // void CompiledInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::reset()

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>   
inline void CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::compound(const TermId& subterm,ulong arity,const NonmaxPathRelation* pathRelation)
{
...
} // void CompiledInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::compound(const TermId& subterm,ulong arity,const NonmaxPathRelation* pathRelation)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::constant(const TermId& subterm,const MaxPathRelation* pathRelation)
{
 ...
 _nextPosition++;
} // void CompiledInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::constant(const TermId& subterm,const MaxPathRelation* pathRelation)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::variable(ulong var)
{
...
} // void CompiledInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::variable(ulong var)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::endOfQuery()
{
 CALL("endOfQuery()");
 ASSERT(!_currentHoles);
...
} // void CompiledInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::endOfQuery()


template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::generateCode()
{
 CALL("generateCode()");
   ...
   switch (pos->tag)
	...
	if (pos->nestPosition == _positions)
     ...
     case Variable:  
      ...
      #ifdef _SUPPRESS_WARNINGS_
       default: 
        RuntimeError::report("Wrong tag in CompiledInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::generateCode()"); 
        return;
      #endif   
     #endif
    };
...
} // void CompiledInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::generateCode()


#ifndef NO_DEBUG_VIS
 template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
 inline ostream& CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::output(ostream& str) const
 {
  for (const Position* p = _positions; p < _nextPosition; p++)
   p->output(str,_positions) << "\n";
  return str;
 } // ostream& CompiledInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::output(ostream& str) const
#endif
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_COMPILED_INSTANCE_RETRIEVAL_WITH_PATH_INDEX
 #define DEBUG_NAMESPACE "CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::Position"
#endif
#include "debugMacros.h"
//============================================================================
...
#ifndef NO_DEBUG_VIS
 template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
 inline ostream& CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::Position::output(ostream& str,const Position* base) const
 {
  str << (this - base) << " ";
  switch (tag) 
   {
  ...
  return str;
 } // ostream& CompiledInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::Position::output(ostream& str,const Position* base) const
#endif
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_COMPILED_INSTANCE_RETRIEVAL_WITH_PATH_INDEX
 #define DEBUG_NAMESPACE "CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine"
#endif
#include "debugMacros.h"
//============================================================================
...
{
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
inline bool CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::nextMatch(TermId& matchId)
{
 CALL("nextMatch(TermId& matchId)");
 ...
 switch (instr->tag) 
  { 
   ...
   case MaxEqualiseTermId:
    ...
    #ifdef _SUPPRESS_WARNINGS_
     default: 
      RuntimeError::report("Wrong tag in CompiledInstanceRetrievalIndex<..>::AbstractMachine::nextMatch(TermId& matchId)"); 
      return false;
    #endif   
   #endif
  };
...
} // bool CompiledInstanceRetrievalIndex<..>::AbstractMachine::nextMatch(TermId& matchId)


#ifndef NO_DEBUG_VIS
       
 template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
 inline ostream& CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::outputCode(ostream& str) const
 {
  ...
  instr->output(str,code,substitution) << "\n"; 
  return str;
 } //  CompiledInstanceRetrievalIndex<..>::AbstractMachine::outputCode(ostream& str) const  
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_COMPILED_INSTANCE_RETRIEVAL_WITH_PATH_INDEX
 #define DEBUG_NAMESPACE "CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::Instruction"
#endif
#include "debugMacros.h"
//============================================================================
...
namespace Gematogen
{
 ...
 template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
 inline ostream& CompiledInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::Instruction::output(ostream& str,const Instruction* base,const TermId* substitution) const
 {
  ...
  return str;
 } //  CompiledInstanceRetrievalIndex<..>::AbstractMachine::Instruction::output(ostream& str,const Instruction* base,const TermId* substitution) const  
