...
class OrdList
{
 public:
  ...
  class Node
    {
    public:
      Node(const KeyType& k) : _next((Node*)0), _key(k){};     
...
#endif   
      friend class OrdList;
      friend class OrdList::Surfer;
    }; // class Node
 ...
 public:
  ...
  const Node* first() const { return (const Node*)_list; };
 ...
 public:
  ...
  class Node
    ...
    private:
      ...
      static ClassDesc _classDesc;
#endif
      friend class VoidOrdList;
      friend class VoidOrdList::Surfer;
    }; // class Node
