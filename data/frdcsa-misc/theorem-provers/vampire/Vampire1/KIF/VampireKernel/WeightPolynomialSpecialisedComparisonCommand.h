//
// File:         WeightPolynomialSpecialisedComparisonCommand.h
 ...
 public:
  ...
  void setTag(const Tag& tag) 
    { 
      _tag = tag;
      DOP(_var = ULONG_MAX);
      DOP(_nativeVar = (void*)0);
      DOP(_label = (Command*)0);
    };
  ...
  void* nativeVar() const
    {
      CALL("nativeVar() const");
      ASSERT(requiresVar());
      return _nativeVar;
    };
  void setNativeVar(void* v)
    {
      CALL("setNativeVar(void* v)");
      ASSERT(requiresVar());
      _nativeVar = v;
    };
