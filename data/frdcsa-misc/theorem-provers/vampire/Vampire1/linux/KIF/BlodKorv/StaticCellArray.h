...
class StaticCellArray
{
 ...
 public:
  ...
  {
   CALLM(_name,"destroyThoroughly()");  
   for (ulong i = 0; i < size(); i++)
    delete (_redirectTable[i]);
   _redirectTable.destroyThoroughly();
  };
  ...
  { 
   ...
   return ReadWriteIterator((WrappedElement*)0);
  };
  ...
  { 
   ...
   return ReadOnlyIterator((WrappedElement*)0);
  };
 ...
 private: 
  ...
  void initCell(ulong i) 
  {
   ...
   else _redirectTable[i]->previous = (WrappedElement*)0;
   _redirectTable[i]->next = (WrappedElement*)0;
  };
 private:
