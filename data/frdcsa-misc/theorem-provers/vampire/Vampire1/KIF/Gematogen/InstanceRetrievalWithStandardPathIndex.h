//
// File:         InstanceRetrievalWithStandardPathIndex.h
...
//============================================================================
#ifndef INSTANCE_RETRIEVAL_WITH_STANDARD_PATH_INDEX_H
//=============================================================================      
...
//============================================================================
#define INSTANCE_RETRIEVAL_WITH_STANDARD_PATH_INDEX_H 
#ifndef NO_DEBUG_VIS
 #include <iostream.h>
#endif 
#include "jargon.h"
...
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_STANDARD_PATH_INDEX
 #define DEBUG_NAMESPACE "StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>"
#endif
...
class StandardInstanceRetrievalIndex
{ 
 public:
  ...
  #endif
 public:
  StandardInstanceRetrievalIndex() 
   : _trie(),
  ...
  ~StandardInstanceRetrievalIndex() 
    {
      CALL("destructor ~StandardInstanceRetrievalIndex()");
 ...
 private: 
   class StandardInstanceRetrievalIndexNonmaxPathRelationId {};
   class StandardInstanceRetrievalIndexMaxPathRelationId {};
  #ifndef INSTANCE_RETRIEVAL_INDEX_NO_SKIP_LISTS
   typedef SmallHeaderVoidSkipList<Alloc,TermId,2,StandardInstanceRetrievalIndexNonmaxPathRelationId> NonmaxPathRelation; 
   typedef SmallHeaderVoidSkipList<Alloc,TermId,2,StandardInstanceRetrievalIndexMaxPathRelationId> MaxPathRelation; 
  ...
  #else
   typedef VoidOrdList<Alloc,TermId,StandardInstanceRetrievalIndexNonmaxPathRelationId> NonmaxPathRelation; 
   typedef VoidOrdList<Alloc,TermId,StandardInstanceRetrievalIndexMaxPathRelationId> MaxPathRelation; 
  ...
  class AbstractMachine
  {
   ...
   public:
    ...
    Stack<ulong,MaxTermSize> allInstantiatedVars; 
  }; //  class AbstractMachine 
  ...
  class IntermediateQueryRepresentation
  {
   ...
   private: 
    ...
    #ifndef INSTANCE_RETRIEVAL_INDEX_NO_PATH_RELATION_SORTING
     GSimpleIncCountingSort<ulong,MaxTermSize> _primaryNestSorting; 
    #else
    ...
    Stack<ulong,MaxTermSize> _allVariablesOccured;
    bool _queryIsGround;
    bool _queryIsLinear;
  }; // class IntermediateQueryRepresentation
...
{
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::integrate(const TermId& integratedTermId)
{
   ...
   { 
    ...
    case TermTraversal::End: 
     ...
     default: ICP("ICP0"); return false;
      ...
      default: 
       RuntimeError::report("Wrong term traversal state in StandardInstanceRetrievalIndex<..>::integrate(..)");
       return false;
     #endif
    #endif       
   };
} // bool StandardInstanceRetrievalIndex<..>::integrate(const TermId& integratedTermId)



template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::remove(const TermId& removedTermId)
{
  ...
  switch (_removedTermTraversal.state())
   { 
    ...
    case TermTraversal::End: 
     ...
     #ifdef _SUPPRESS_WARNINGS_
      default: 
       RuntimeError::report("Wrong term traversal state in StandardInstanceRetrievalIndex<..>::remove(..)");
       return false;
     #endif
    #endif       
   };

} // bool StandardInstanceRetrievalIndex<..>::remove(const TermId& removedTermId)



template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline void StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::destroy()
{
 CALL("destroy()");
 bool wasConstant;
...
} // void StandardInstanceRetrievalIndex<..>::destroy()


template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::compileQuery(const TermId& query)
{
  ...
  switch (_queryTraversal.state())
   {
    ...
    case TermTraversal::End: 
     ...
     #ifdef _SUPPRESS_WARNINGS_
      default: 
       RuntimeError::report("Wrong term traversal state in StandardInstanceRetrievalIndex<..>::compileQuery(..)");
       return false;
     #endif
    #endif    
  };
 
} // bool StandardInstanceRetrievalIndex<..>::compileQuery(const TermId& query)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::nextMatch(TermId& matchId)
{
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_STANDARD_PATH_INDEX
 #define DEBUG_NAMESPACE "StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation"
#endif
#include "debugMacros.h"
//============================================================================
...
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline void StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::reset()
{
 CALL("reset()");
...
} // void StandardInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::reset()

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>   
inline void StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::compound(const TermId& subterm,ulong arity,const NonmaxPathRelation* pathRelation)
{
...
} // void StandardInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::compound(const TermId& subterm,ulong arity,const NonmaxPathRelation* pathRelation)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::constant(const TermId& subterm,const MaxPathRelation* pathRelation)
{
 ...
 _nextPosition++;
} // void StandardInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::constant(const TermId& subterm,const MaxPathRelation* pathRelation)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::variable(ulong var)
{
...
} // void StandardInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::variable(ulong var)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::endOfQuery()
{
 CALL("endOfQuery()");
 ASSERT(!_currentHoles);
...
} // void StandardInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::endOfQuery()


template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::generateCode()
{
 CALL("generateCode()");
 #ifndef INSTANCE_RETRIEVAL_INDEX_NO_PATH_RELATION_SORTING 
   ...
   switch (pos->tag)
	...
	if (pos->hasNonvarArg) // secondary  
      ...
      */
      ...
      #ifdef _SUPPRESS_WARNINGS_
       default: 
        RuntimeError::report("Wrong tag in StandardInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::generateCode()"); 
        return;
      #endif   
     #endif
    };
...
} // void StandardInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::generateCode()


#ifndef NO_DEBUG_VIS
 template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
 inline ostream& StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::output(ostream& str) const
 {
  for (const Position* p = _positions; p < _nextPosition; p++)
   p->output(str,_positions) << "\n";
  return str;
 } // ostream& StandardInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::output(ostream& str) const
#endif
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_STANDARD_PATH_INDEX
 #define DEBUG_NAMESPACE "StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::Position"
#endif
#include "debugMacros.h"
//============================================================================
...
#ifndef NO_DEBUG_VIS
 template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
 inline ostream& StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::Position::output(ostream& str,const Position* base) const
 {
  str << (this - base) << " ";
  switch (tag) 
   {
  ...
  return str;
 } // ostream& StandardInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::Position::output(ostream& str,const Position* base) const
#endif
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_STANDARD_PATH_INDEX
 #define DEBUG_NAMESPACE "StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine"
#endif
#include "debugMacros.h"
//============================================================================
...
{
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
inline bool StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::nextMatch(TermId& matchId)
{
 CALL("nextMatch(TermId& matchId)");
 ...
 switch (instr->tag) 
  { 
   ...
   case MaxEqualiseTermId:
    ...
    #ifdef _SUPPRESS_WARNINGS_
     default: 
      RuntimeError::report("Wrong tag in StandardInstanceRetrievalIndex<..>::AbstractMachine::nextMatch(TermId& matchId)"); 
      return false;
    #endif   
   #endif
  };
...
} // bool StandardInstanceRetrievalIndex<..>::AbstractMachine::nextMatch(TermId& matchId)


template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
inline bool StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::match(const TermId& candidate)
{
  ...
  switch (queryTraversal.state())
   {
    ...
    case TermTraversal::End:
     ...
     #ifdef _SUPPRESS_WARNINGS_
      default: 
       RuntimeError::report("Wrong term traversal state in StandardInstanceRetrievalIndex<..>::AbstractMachine::match(..)");
       return false;
     #endif
    #endif    
  };
}; // bool StandardInstanceRetrievalIndex<..>::AbstractMachine::match(const TermId& candidate)


template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
inline void StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::extractSubstitution(const TermId& candidate)
{
  ...
  switch (queryTraversal.state())
   {
    ...
    case TermTraversal::End:
     ...
     #ifdef _SUPPRESS_WARNINGS_
      default: 
       RuntimeError::report("Wrong term traversal state in StandardInstanceRetrievalIndex<..>::AbstractMachine::extractSubstitution(..)");
     #endif
    #endif    
  };
}; // void StandardInstanceRetrievalIndex<..>::AbstractMachine::extractSubstitution(const TermId& candidate)


#ifndef NO_DEBUG_VIS
       
 template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
 inline ostream& StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::outputCode(ostream& str) const
 {
  ...
  instr->output(str,code,substitution) << "\n"; 
  return str;
 } //  StandardInstanceRetrievalIndex<..>::AbstractMachine::outputCode(ostream& str) const  
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_STANDARD_PATH_INDEX
 #define DEBUG_NAMESPACE "StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::Instruction"
#endif
#include "debugMacros.h"
//============================================================================
...
namespace Gematogen
{
 ...
 template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
 inline ostream& StandardInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::Instruction::output(ostream& str,const Instruction* base,const TermId* substitution) const
 {
  ...
  return str;
 } //  StandardInstanceRetrievalIndex<..>::AbstractMachine::Instruction::output(ostream& str,const Instruction* base,const TermId* substitution) const  
