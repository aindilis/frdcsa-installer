...
class ProblemProfile
{
 ...
 public:
  ...
  ~ProblemProfile() { CALL("destructor ~ProblemProfile()"); };
  void reset();
 ...
 private:
  ...
  Array<GlobAlloc,PredInfo,128UL,ProblemProfile> _predInfoTable;
  Array<GlobAlloc,FuncInfo,128UL,ProblemProfile> _funcInfoTable;
