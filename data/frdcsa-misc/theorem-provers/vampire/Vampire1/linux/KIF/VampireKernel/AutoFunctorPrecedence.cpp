...
long VK::AutoFunctorPrecedence::InitStatic::_count; // Implicitely initialised to 0L

#ifdef DEBUG_ALLOC_OBJ_TYPE
#include "ClassDesc.h"
using namespace BK;
ClassDesc 
VK::AutoFunctorPrecedence::ArityFuncSortTree::LeftRightIter::NodeList::_classDesc("AutoFunctorPrecedence::ArityFuncSortTree::LeftRightIter::NodeList",
									      VK::AutoFunctorPrecedence::ArityFuncSortTree::LeftRightIter::NodeList::minSize(),
									      VK::AutoFunctorPrecedence::ArityFuncSortTree::LeftRightIter::NodeList::maxSize());

ClassDesc 
VK::AutoFunctorPrecedence::ArityFuncSortTree::RightLeftIter::NodeList::_classDesc("AutoFunctorPrecedence::ArityFuncSortTree::RightLeftIter::NodeList",
									      VK::AutoFunctorPrecedence::ArityFuncSortTree::RightLeftIter::NodeList::minSize(),
									      VK::AutoFunctorPrecedence::ArityFuncSortTree::RightLeftIter::NodeList::maxSize());

ClassDesc 
VK::AutoFunctorPrecedence::ArityFuncSortTree::Node::_classDesc("AutoFunctorPrecedence::ArityFuncSortTree::Node",
							       VK::AutoFunctorPrecedence::ArityFuncSortTree::Node::minSize(),
							       VK::AutoFunctorPrecedence::ArityFuncSortTree::Node::maxSize());
...
{ 
  ...
  _maximalFixedPrecedence = max(abs(_maximalFixedPrecedence),abs(_minimalFixedPrecedence));
