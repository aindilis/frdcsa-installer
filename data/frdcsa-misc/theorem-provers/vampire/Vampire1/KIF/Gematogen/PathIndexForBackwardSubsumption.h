//
// File:         PathIndexForBackwardSubsumption.h
...
class PathIndexForBackwardSubsumption
{
 ...
 private:
  ...
  typedef SmallHeaderSkipList<Alloc,LitSubtList*,ClauseId,2UL,OrdLitNonmaxPathRelationId> OrdLitNonmaxPathRelation;
  typedef SmallHeaderSkipList<Alloc,LiteralNumber,ClauseId,2UL,OrdLitMaxPathRelationId> OrdLitMaxPathRelation;
  typedef SmallHeaderSkipList<Alloc,LitSubtList*,ClauseId,2UL,SymLitNonmaxPathRelationId> SymLitNonmaxPathRelation;
  typedef SmallHeaderSkipList<Alloc,LiteralNumber,ClauseId,2UL,SymLitMaxPathRelationId> SymLitMaxPathRelation;

  typedef OptimisedPathIndex<Alloc,Symbol,OrdLitNonmaxPathRelation,OrdLitMaxPathRelation,MaxTermDepth,MaxTermSize> 
    PathIndexForOrdinaryLits;
  typedef OptimisedPathIndex<Alloc,Symbol,SymLitNonmaxPathRelation,SymLitMaxPathRelation,MaxTermDepth,MaxTermSize> 
