//
// File:         InstanceRetrievalWithOptimisedPathIndexAndEarlySubstFactoring.h
// Description:  Optimised indexing for instance retrieval
//               based on path-indexing + database joins 
//               + some substitution factoring instructions
...
//============================================================================
#ifndef INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX_AND_EARLY_SUBST_FACTORING_H
//=============================================================================      
...
//============================================================================
#define INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX_AND_EARLY_SUBST_FACTORING_H 
#ifndef NO_DEBUG_VIS
#include <iostream.h>
#endif 
#include "jargon.h"
...
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX_AND_EARLY_SUBST_FACTORING
#define DEBUG_NAMESPACE "OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>"
#endif
...
class OptimisedInstanceRetrievalWithEarlySubstFactoringIndex
{ 
 public:
...
#endif
 public:
  OptimisedInstanceRetrievalWithEarlySubstFactoringIndex() 
    : 
 ...
 private: 
  typedef SmallHeaderSkipList<Alloc,TermArguments,TermId,2,OptimisedInstanceRetrievalWithEarlySubstFactoringIndex> NonmaxPathRelation;
  typedef SmallHeaderVoidSkipList<Alloc,TermId,2,OptimisedInstanceRetrievalWithEarlySubstFactoringIndex> MaxPathRelation;  
  typedef OptimisedPathIndex<Alloc,Symbol,NonmaxPathRelation,MaxPathRelation,MaxTermDepth,MaxTermSize> PathIndexForInstanceRetrieval;
  ...
  class IntermediateQueryRepresentation
    ...
    private: 
      ...
      Stack<ulong,MaxTermDepth> _backtrackHoles;
      Stack<Position*,MaxTermDepth> _backtrackNonmaxPositions;

      // data used locally in code generation 
      GIncCountingSort<ulong,PositionPtr,MaxTermSize> _primaryNestSorting;
      Stack<Position*,MaxTermSize> _secondaryNests; 
      ...
      Multiset<ulong,MaxNumOfVariables> _internalVars;   
      MultisetWithRemoval<ulong,MaxNumOfVariables> _singletonVars;
...
#ifndef NO_DEBUG
  LinearCombination<long,MaxNumOfVariables> _debugQueryVariables;
#endif
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX_AND_EARLY_SUBST_FACTORING
#define DEBUG_NAMESPACE "OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>"
#endif
#include "debugMacros.h"
//============================================================================
...
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::integrate(const TermId& integratedTermId)
{
 ...
 check_state:
  switch (_integratedTermTraversal.state())
    ...
    default: 
      RuntimeError::report("Wrong term traversal state in OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::integrate(..)");
      return false;
#endif
#endif       
    };
} // bool OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::integrate(const TermId& integratedTermId)



template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::remove(const TermId& removedTermId)
{
...
#ifdef _SUPPRESS_WARNINGS_
    default: 
      RuntimeError::report("Wrong term traversal state in OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::remove(..)");
      return false;
#endif
#endif       
    };

} // bool OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::remove(const TermId& removedTermId)



template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::destroyThoroughly()
{
  CALL("destroyThoroughly()");
  bool wasConstant;
  if (_destruction.reset(_trie))
    {
      while (_destruction.next(wasConstant))
	{ 
	  if (wasConstant)
	    {
	      // _destruction.constIndObj().destroyThoroughly(); 
	    }
	  else // !wasConstant
	    {
	      // _destruction.indexedObj().destroyThoroughly();
	    }; 
	};
  ...
  _removal.destroyThoroughly();
  _destruction.destroyThoroughly();
  _pathRelationRetrieval.destroyThoroughly();
  _intermediateQueryRepresentation.destroyThoroughly(); 
  _abstractMachine.destroyThoroughly();

} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::destroy()


template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::compileQuery(const TermId& query)
{
...
#ifdef _SUPPRESS_WARNINGS_
    default: 
      RuntimeError::report("Wrong term traversal state in OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::compileQuery(..)");
      return false;
#endif
#endif    
    };
 
} // bool OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::compileQuery(const TermId& query)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::nextMatch(TermId& matchId)
{
...
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
ostream& OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::outputSubst(ostream& str) const
{
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX_AND_EARLY_SUBST_FACTORING
#define DEBUG_NAMESPACE "OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation"
#endif
#include "debugMacros.h"
//============================================================================
...
{
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::reset()
{
  CALL("reset()");
...
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::reset()

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>   
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::compound(const TermId& subterm,ulong arity,const NonmaxPathRelation* pathRelation)
{
...
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::compound(const TermId& subterm,ulong arity,const NonmaxPathRelation* pathRelation)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::constant(const TermId& subterm,const MaxPathRelation* pathRelation)
{
  ...
  _nextPosition++;
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::constant(const TermId& subterm,const MaxPathRelation* pathRelation)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::variable(ulong var)
{
...
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::variable(ulong var)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::endOfQuery()
{
  CALL("endOfQuery()");
  ASSERT(!_currentHoles);
...
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::endOfQuery()


template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::generateCode()
{
  CALL("generateCode()");
...
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::generateCode()
...
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::generatePrimaryCode()
{
...
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::generatePrimaryCode()



template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::generateSecondaryCode()
{
  ...
  while (_secondaryNests.nonempty()) 
    {
      ...
      _internalVars.reset();
      for (Position* varPos = (*bestChoice)->nextVarArg; varPos; varPos = varPos->nextVarArg)
	{
	  ...
	  if (_substLoaded[var]) 
	    ...
	    { 
	      varPos->mainInstruction = (AbstractMachine::Instruction*)0;
	      if (_availableVarPosition[var] || _internalVars.scoreOf(var)) 
		{ 
		  maxAvailComp++;
		}
	      else _internalVars.add(var);
	    };       
	}; // for ...
      ...
      for (Position** nst = _secondaryNests.begin() + 1; nst != endOfNests; nst++)
	{
	  ...
	  ulong availComp = 0UL;
	  _internalVars.reset(); 
	  for (Position* varPos = (*nst)->nextVarArg; varPos; varPos = varPos->nextVarArg)
	    {
	      ulong var = varPos->variable;
	      if (_substLoaded[var]) 
		{
      ...
      if (maxImmediateComp)
	{
	  ...
	  for (Position* varPos = secondaryNest->nextVarArg; varPos; varPos = varPos->nextVarArg)
	    {
	      ulong var = varPos->variable;
	      if (_substLoaded[var]) 
		{
...
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::generateSecondaryCode()



template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::generateCodeForSingletons()
{
...
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::generateCodeForSingletons()



template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::writeNonmaxEqualiseTermId(Position* primaryNest)
{
  ...
  _nextInstr++;
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::writeNonmaxEqualiseTermId(Position* primaryNest)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::writeMaxEqualiseTermId(Position* primaryNest)
{
  ...
  _nextInstr++;
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::writeMaxEqualiseTermId(Position* primaryNest)



template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::writeGetToTermId(Position* secondaryNest)
{
  ...
  _nextInstr++; 
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::writeGetToTermId(Position* secondaryNest)



template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::writeCompare(Position* varPos)
{
  ...
  _nextInstr++;
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::writeCompare(Position* varPos)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::writeLoadSubst(Position* varPos)
{
  ...
  _nextInstr->subst = _abstractMachine->substitution + varPos->variable; 
  _nextInstr++;
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::writeLoadSubst(Position* varPos)
...
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::superimposeCompare(AbstractMachine::Instruction* instr,Position* varPos)
{
...
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::superimposeCompare(AbstractMachine::Instruction* instr,Position* varPos)


template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::superimposeLoadSubst(AbstractMachine::Instruction* instr,Position* varPos)
{
  ...
  instr->argNum = varPos->argNum;
  instr->subst = _abstractMachine->substitution + varPos->variable;   
} // void OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::superimposeLoadSubst(AbstractMachine::Instruction* instr,Position* varPos)
...
#ifndef NO_DEBUG_VIS
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline ostream& OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::output(ostream& str)
{
  ...
  return str << "\n";
} // ostream& OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::output(ostream& str)
#endif
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX_AND_EARLY_SUBST_FACTORING
#define DEBUG_NAMESPACE "OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::Position"
#endif
#include "debugMacros.h"
//============================================================================
...
#ifndef NO_DEBUG_VIS
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline ostream& OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::Position::output(ostream& str,const Position* base) const
{
  str << (this - base) << " ";
  switch (tag) 
    {
  ...
  return str;
} // ostream& OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::IntermediateQueryRepresentation::Position::output(ostream& str,const Position* base) const
#endif
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX_AND_EARLY_SUBST_FACTORING
#define DEBUG_NAMESPACE "OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine"
#endif
#include "debugMacros.h"
//============================================================================
...
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
inline bool OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::nextMatch(TermId& matchId)
{
  CALL("nextMatch(TermId& matchId)");
...
#ifdef _SUPPRESS_WARNINGS_
    default: 
      RuntimeError::report("Wrong tag in OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::AbstractMachine::nextMatch(TermId& matchId)"); 
      return false;
#endif   
#endif
    };
...
} // bool OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::AbstractMachine::nextMatch(TermId& matchId)


#ifndef NO_DEBUG_VIS
       
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
inline ostream& OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::outputCode(ostream& str) const
{
  ...
  instr->output(str,this,substitution) << "\n"; 
  return str;
} //  OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::AbstractMachine::outputCode(ostream& str) const  
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX_AND_EARLY_SUBST_FACTORING
#define DEBUG_NAMESPACE "OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::Instruction"
#endif
#include "debugMacros.h"
//============================================================================
...
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
inline ostream& OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::Instruction::output(ostream& str,const AbstractMachine* machine,const TermId* substitution) const
{
  ...
  return str;
} //  OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::AbstractMachine::Instruction::output(ostream& str,const AbstractMachine* machine,const TermId* substitution) const  


template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
inline ulong OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::surferNum(const NonmaxPathRelation::Node* const * currNdAddr) const
{
  for (ulong res = 0UL; res < MaxTermSize; res++)
    if (nonmaxPathRelationSurfers[res].currNodeAddr() == currNdAddr) return res;
  RuntimeError::report("Surfer not found in  OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::AbstractMachine::surferNum(const NonmaxPathRelation::Node* const * currNdAddr) const");
  return 0UL; // dummy
} // ulong OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::AbstractMachine::surferNum(const NonmaxPathRelation::Node* const * currNdAddr) const

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
inline ulong OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::surferNum(const NonmaxPathRelation::SurferWithMemory* surf) const
{
  return surf - nonmaxPathRelationSurfers;
} // ulong OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::AbstractMachine::surferNum(const NonmaxPathRelation::SurferWithMemory* surf) const

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
inline ulong OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::surferNum(const MaxPathRelation::SurferWithMemory* surf) const
{
  return surf - maxPathRelationSurfers; 
} // ulong OptimisedInstanceRetrievalWithEarlySubstFactoringIndex<..>::AbstractMachine::surferNum(const MaxPathRelation::SurferWithMemory* surf) const
