//
// File:         InstanceRetrievalWithOptimisedPathIndex.h
...
//============================================================================
#ifndef INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX_H
//=============================================================================      
...
//============================================================================
#define INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX_H 
#ifndef NO_DEBUG_VIS
 #include <iostream.h>
#endif 
#include "jargon.h"
...
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX
...
class OptimisedInstanceRetrievalIndex
{ 
 public:
  ...
  #endif
 public:
  OptimisedInstanceRetrievalIndex() 
   : _trie(),
 ...
 private: 
  typedef SmallHeaderSkipList<Alloc,TermArguments,TermId,2,OptimisedInstanceRetrievalIndex> NonmaxPathRelation;
  typedef SmallHeaderVoidSkipList<Alloc,TermId,2,OptimisedInstanceRetrievalIndex> MaxPathRelation;  
...
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::integrate(const TermId& integratedTermId)
{
   ...
   { 
    ...
    case TermTraversal::End: 
     ...
     default: ICP("ICP0"); return false;
      ...
      default: 
       RuntimeError::report("Wrong term traversal state in OptimisedInstanceRetrievalIndex<..>::integrate(..)");
       return false;
     #endif
    #endif       
   };
} // bool OptimisedInstanceRetrievalIndex<..>::integrate(const TermId& integratedTermId)



template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::remove(const TermId& removedTermId)
{
  ...
  switch (_removedTermTraversal.state())
   { 
    ...
    case TermTraversal::End: 
     ...
     #ifdef _SUPPRESS_WARNINGS_
      default: 
       RuntimeError::report("Wrong term traversal state in OptimisedInstanceRetrievalIndex<..>::remove(..)");
       return false;
     #endif
    #endif       
   };

} // bool OptimisedInstanceRetrievalIndex<..>::remove(const TermId& removedTermId)



template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline void OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::destroy()
{
 CALL("destroy()");
 bool wasConstant;
...
} // void OptimisedInstanceRetrievalIndex<..>::destroy()


template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::compileQuery(const TermId& query)
{
  ...
  switch (_queryTraversal.state())
   {
    ...
    case TermTraversal::End: 
     ...
     #ifdef _SUPPRESS_WARNINGS_
      default: 
       RuntimeError::report("Wrong term traversal state in OptimisedInstanceRetrievalIndex<..>::compileQuery(..)");
       return false;
     #endif
    #endif    
  };
 
} // bool OptimisedInstanceRetrievalIndex<..>::compileQuery(const TermId& query)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline bool OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::nextMatch(TermId& matchId)
{
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX
 #define DEBUG_NAMESPACE "OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation"
#endif
#include "debugMacros.h"
//============================================================================
...
{
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>
inline void OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::reset()
{
 CALL("reset()");
...
} // void OptimisedInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::reset()

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>   
inline void OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::compound(const TermId& subterm,ulong arity,const NonmaxPathRelation* pathRelation)
{
...
} // void OptimisedInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::compound(const TermId& subterm,ulong arity,const NonmaxPathRelation* pathRelation)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::constant(const TermId& subterm,const MaxPathRelation* pathRelation)
{
 ...
 _nextPosition++;
} // void OptimisedInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::constant(const TermId& subterm,const MaxPathRelation* pathRelation)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::variable(ulong var)
{
...
} // void OptimisedInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::variable(ulong var)

template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::endOfQuery()
{
 CALL("endOfQuery()");
 ASSERT(!_currentHoles);
...
} // void OptimisedInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::endOfQuery()


template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
inline void OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::generateCode()
{
 CALL("generateCode()");
  ...
  { 
   switch (pos->tag)
	...
	// or the nest has been already compiled
      ...
      #ifdef _SUPPRESS_WARNINGS_
       default: 
        RuntimeError::report("Wrong tag in OptimisedInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::generateCode()"); 
        return;
      #endif   
     #endif
    };
...
} // void OptimisedInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::generateCode()


#ifndef NO_DEBUG_VIS
 template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
 inline ostream& OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::output(ostream& str) const
 {
  for (const Position* p = _positions; p < _nextPosition; p++)
   p->output(str,_positions) << "\n";
  return str;
 } // ostream& OptimisedInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::output(ostream& str) const
#endif
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX
 #define DEBUG_NAMESPACE "OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::Position"
#endif
#include "debugMacros.h"
//============================================================================
...
#ifndef NO_DEBUG_VIS
 template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>    
 inline ostream& OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::IntermediateQueryRepresentation::Position::output(ostream& str,const Position* base) const
 {
  str << (this - base) << " ";
  switch (tag) 
   {
  ...
  return str;
 } // ostream& OptimisedInstanceRetrievalIndex<..>::IntermediateQueryRepresentation::Position::output(ostream& str,const Position* base) const
#endif
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX
 #define DEBUG_NAMESPACE "OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine"
#endif
#include "debugMacros.h"
//============================================================================
...
template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
inline bool OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::nextMatch(TermId& matchId)
{
 CALL("nextMatch(TermId& matchId)");
 ...
 switch (instr->tag) 
  { 
   ...
   case MaxEqualiseTermId:
    ...
    #ifdef _SUPPRESS_WARNINGS_
     default: 
      RuntimeError::report("Wrong tag in OptimisedInstanceRetrievalIndex<..>::AbstractMachine::nextMatch(TermId& matchId)"); 
      return false;
    #endif   
   #endif
  };
...
} // bool OptimisedInstanceRetrievalIndex<..>::AbstractMachine::nextMatch(TermId& matchId)


#ifndef NO_DEBUG_VIS
       
 template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
 inline ostream& OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::outputCode(ostream& str) const
 {
  ...
  instr->output(str,code,substitution) << "\n"; 
  return str;
 } //  OptimisedInstanceRetrievalIndex<..>::AbstractMachine::outputCode(ostream& str) const  
...
#undef DEBUG_NAMESPACE
#ifdef DEBUG_INSTANCE_RETRIEVAL_WITH_OPTIMISED_PATH_INDEX
 #define DEBUG_NAMESPACE "OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::Instruction"
#endif
#include "debugMacros.h"
//============================================================================
...
namespace Gematogen
{
 ...
 template <class Alloc,class Term,ulong MaxTermDepth,ulong MaxTermSize,ulong MaxNumOfVariables>  
 inline ostream& OptimisedInstanceRetrievalIndex<Alloc,Term,MaxTermDepth,MaxTermSize,MaxNumOfVariables>::AbstractMachine::Instruction::output(ostream& str,const Instruction* base,const TermId* substitution) const
 {
  ...
  return str;
 } //  OptimisedInstanceRetrievalIndex<..>::AbstractMachine::Instruction::output(ostream& str,const Instruction* base,const TermId* substitution) const  
