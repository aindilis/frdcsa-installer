...
//               is replace by 
//               TMP_LITERAL* _numLitMap[HellConst::MaxNumOfLiterals] 
//============================================================================
#ifndef SPLITTING_H
//============================================================================
#define SPLITTING_H 
...
class Splitting
{
 ...
 private:
  ...
  Array<GlobAlloc,TMP_LITERAL*,32UL,Splitting> _numLitMap;
  ...
  Array<GlobAlloc,TmpLitList,32UL,Splitting> _components;


  ExpandingMultiset<GlobAlloc,ulong,32UL,Splitting> _registeredCompNums;


  Array<GlobAlloc,ulong,32UL,Splitting> _componentName;    

 
  Array<GlobAlloc,bool,32UL,Splitting> _newCompName;  
