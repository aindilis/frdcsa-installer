...
typedef BitSet<GlobAlloc> FunSet;
...
class FS_COMMAND
 {
  ...
  private: // structure
   ...
   #endif
  public:
   FS_COMMAND(TAG t) : fork((FS_COMMAND*)0), next((FS_COMMAND*)0), tag(t) 
   {
   ...
   inline void* operator new(size_t)
    {
     CALL("operator new(size_t)");
      ...
      return GlobAlloc::allocate(sizeof(FS_COMMAND),&_classDesc);
     #else
      return GlobAlloc::allocate(sizeof(FS_COMMAND)); 
     #endif
    };
   inline void operator delete(void* obj)
    {
     CALL("operator delete(void* obj)"); 
      ...
      GlobAlloc::deallocate(obj,sizeof(FS_COMMAND),&_classDesc);
     #else
      GlobAlloc::deallocate(obj,sizeof(FS_COMMAND));
     #endif
    };
   ...
   inline void* IndexedObject() const { return (void*)arg1.clause; }; 
   inline void SetClause(Clause* cl) { arg1.clause = cl; };
   inline void SetIndexedObject(void* obj) { arg1.clause = (Clause*)obj; };
   ...
   void SetNumOfLits(ulong n) { next = (FS_COMMAND*)n; }; 
