...
(define
 ...
 (:requirements :fluents :conditional-effects :equality :durative-actions :derived-predicates :timed-initial-literals :negative-preconditions :typing :disjunctive-preconditions)
